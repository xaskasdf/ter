...
$Src = Join-Path $Dir 'ter_cuda_forward_packed_v13_int4tc.cu'
$Bin = Join-Path $Dir 'ter_cuda_forward_packed_v13_int4tc.exe'
[Console]::Error.WriteLine("[int4 smoke] Compiling ...")
...
[Console]::Error.WriteLine("[int4 smoke] Running ...")
& $Bin
exit $LASTEXITCODE
